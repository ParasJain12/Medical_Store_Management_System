				...
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="registerAdmin.jsp" class="form">
		      		<div class="form-group">
		      			<input type="text" class="form-control" placeholder="Enter AdminID"  maxlength="30" id="txtAid" name="txtAid"  onchange="email_validate(this.value);" required>
		      		</div>
	            <div class="form-group">
	              <input  type="password" class="form-control" placeholder="Enter Password" maxlength=16 id="txtPassword" name="txtPassword" required>
