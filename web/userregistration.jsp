    ...
    <div class="container">
        ...
        <div class="col-md-2"></div>
            <div class="col-md-8">
                ...
                <form action="registerUser.jsp" method="post" id="fileForm" role="form">
                <fieldset><h2 align="center">User Registrations<span class="req"><small> required *</small></span></h2>
                    ...
                    <div class="form-group">
                        <label for="username"><span class="req">* </span> User name:  <small>This will be your login user name</small> </label> 
                            <input class="form-control" type="text" name="username" id = "username" onchange="user_validate(this.value)"; placeholder="minimum 6 letters" required />  
                                <div id="errLast"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" name="phonenumber" id="phonenumber" class="form-control phone" maxlength="28" onkeyup="validatephone(this);" placeholder="Mobile no."/> 
                    </div>
